...
""" 
    ...
    {
     'handle_invalid': 'keep', 
     'onehot_conf': [['country', 'country_onehot'], ['hour', 'hour-onehot'], ['score', 'score-onehot']], 'other_col_output': ['id', 'clicked'],
    ...
    +---+-------+--------------+---------------+-------------+
    |5  |5      |(5,[3],[1.0]) |(19,[15],[1.0])|(4,[0],[1.0])|
    |2  |4      |(5,[4],[1.0]) |(19,[12],[1.0])|(4,[0],[1.0])|
    |4  |9      |(5,[1],[1.0]) |(19,[4],[1.0]) |(4,[2],[1.0])|
    |3  |5      |(5,[2],[1.0]) |(19,[5],[1.0]) |(4,[3],[1.0])|
    |1  |2      |(5,[0],[1.0]) |(19,[18],[1.0])|(4,[1],[1.0])|
    +---+-------+--------------+---------------+-------------+
